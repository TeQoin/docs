...
<Steps>
  ...
  <Step title="Search for TeQoin Wallet">
    Search for **@TeQoin_Wallet_Bot** in Telegram
    
    Or click this link: [t.me/TeQoin_Wallet_Bot](https://t.me/TeQoin_Wallet_Bot)
  </Step>
  ...
  <Tab title="iOS">
    <Steps>
      ...
      <Step title="Enter Details">
        ...
        - **Chain ID:** 420377
        - **Symbol:** ETH
        - **Block Explorer:** https://testnet-blockscan.teqoin.io/
      </Step>
...
| **Block Explorer** | https://testnet-blockscan.teqoin.io/ | View transactions |
...
<AccordionGroup>
  <Accordion title="Can't find @TeQoin_Wallet_Bot on Telegram">
    ...
    **Solution:**
    ...
    4. Or visit: https://t.me/TeQoin_Wallet_Bot
  </Accordion>
